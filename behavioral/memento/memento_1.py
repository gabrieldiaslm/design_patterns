'''
GoF - Memento é um padrão de projeto comportmanetal que tem
a intenção de permitir que você salve e restaure um estado
anterior de um objeto originator sem revelar os detalhes
...
if __name__ == '__main__':
    img = ImageEditor('foto1.jpg', 111, 111)
