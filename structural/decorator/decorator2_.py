...
if __name__ == '__main__':
    ...
    bacon_simplehotdog = HotdogDecorator(simplehotdog, Bacon())
    print(bacon_simplehotdog)

    egg_bacon_simplehotdog = HotdogDecorator(bacon_simplehotdog, Egg())
    print(egg_bacon_simplehotdog)