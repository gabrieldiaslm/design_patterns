'''
Façade (fachada) é um padrão de projeto estrutural que tem
a intenção de fornecer uma interface unificada para um
conjunto de interfaces em um subsistema. Façade define uma 
interface de nível mais alto que torna o subsistema mais 
fácil de ser usado.
'''
...
class Notebook(IObserver):
    ...
    def show(self):
        ...
        print('notebook fará outra coisa com esses dados...', state)
